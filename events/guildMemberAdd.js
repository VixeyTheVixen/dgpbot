...
module.exports = async (client, member) => {
  ...
  const message = new Discord.RichEmbed()
    ...
    .setColor('RANDOM')
    .setAuthor('👋 Bem-vindo(a) ao DGP Mundo!')
    .setTitle('Aproveite sua conversa em <#440913811994705921>!')
    .setDescription(`${member}, vá em <#709479485858250815> e leia as regras.`)
    .setFooter('2020 - DGP Mundo')
    .setTimestamp()
